 ...
 * @method \Vendor\Waha\Generated\Model\WAMessage sendText(string $chatId, string $text, ?string $id = null, ?string $reply_to = null, ?bool $linkPreview = true, ?bool $linkPreviewHighQuality = false, ?string $session = null)
 ...
 * @method \Vendor\Waha\Generated\Model\WAMessage forwardMessage(string $chatId, string $messageId, ?string $id = null, ?string $session = null)
 ...
 * @method mixed sendPoll(string $chatId, \Vendor\Waha\Generated\Model\MessagePoll $poll, ?string $id = null, ?string $reply_to = null, ?string $session = null)
 ...
 * @method array postChatsOverview(\Vendor\Waha\Generated\Model\GetChatsOverviewParams $pagination, \Vendor\Waha\Generated\Model\OverviewFilter $filter, ?string $session = null)
 ...
 * @method \Vendor\Waha\Generated\Model\WAMessage getChatMessage(string $chatId, string $messageId, ?bool $downloadMedia = true, ?bool $merge = true, ?string $session = null)
