 ...
 * @method \AfroTechnology\Waha\Generated\Model\WAMessage sendText(string $chatId, string $text, ?string $reply_to = null, ?bool $linkPreview = true, ?bool $linkPreviewHighQuality = false, ?string $session = null)
 ...
 * @method \AfroTechnology\Waha\Generated\Model\WAMessage forwardMessage(string $chatId, string $messageId, ?string $session = null)
 ...
 * @method mixed sendPoll(string $chatId, \AfroTechnology\Waha\Generated\Model\MessagePoll $poll, ?string $reply_to = null, ?string $session = null)
 ...
 * @method array postChatsOverview(\AfroTechnology\Waha\Generated\Model\OverviewPaginationParams $pagination, \AfroTechnology\Waha\Generated\Model\OverviewFilter $filter, ?string $session = null)
 ...
 * @method \AfroTechnology\Waha\Generated\Model\WAMessage getChatMessage(string $chatId, string $messageId, ?bool $downloadMedia = true, ?string $session = null)
