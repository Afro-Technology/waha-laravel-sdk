...
/**
 * WAHASessionPresence Class Doc Comment
 *
 * @category Class
 * @package  AfroTechnology\Waha\Generated
 * @author   OpenAPI Generator team
 ...
 */
class WAHASessionPresence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WAHASessionPresence';
    ...
    */
     ...
     * Sets chat_id
     *
     * @param string|null $chat_id Chat ID - either group id or contact id. Required for chat-related presence statuses; omit for ONLINE/OFFLINE.
     *
     * @return self
     */
