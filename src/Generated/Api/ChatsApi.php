...
class ChatsApi
{
     ...
     */
    public function chatsControllerGetChatMessage($session, $chat_id, $message_id, $download_media = true, $merge = true, string $contentType = self::contentTypes['chatsControllerGetChatMessage'][0])
    {
        list($response) = $this->chatsControllerGetChatMessageWithHttpInfo($session, $chat_id, $message_id, $download_media, $merge, $contentType);
        return $response;
    }
     ...
     */
    public function chatsControllerGetChatMessageWithHttpInfo($session, $chat_id, $message_id, $download_media = true, $merge = true, string $contentType = self::contentTypes['chatsControllerGetChatMessage'][0])
    {
        $request = $this->chatsControllerGetChatMessageRequest($session, $chat_id, $message_id, $download_media, $merge, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatsControllerGetChatMessageAsync($session, $chat_id, $message_id, $download_media = true, $merge = true, string $contentType = self::contentTypes['chatsControllerGetChatMessage'][0])
    {
        return $this->chatsControllerGetChatMessageAsyncWithHttpInfo($session, $chat_id, $message_id, $download_media, $merge, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatsControllerGetChatMessageAsyncWithHttpInfo($session, $chat_id, $message_id, $download_media = true, $merge = true, string $contentType = self::contentTypes['chatsControllerGetChatMessage'][0])
    {
        $returnType = '\Vendor\Waha\Generated\Model\WAMessage';
        $request = $this->chatsControllerGetChatMessageRequest($session, $chat_id, $message_id, $download_media, $merge, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function chatsControllerGetChatMessageRequest($session, $chat_id, $message_id, $download_media = true, $merge = true, string $contentType = self::contentTypes['chatsControllerGetChatMessage'][0])
    {
     ...
     * @return \Vendor\Waha\Generated\Model\WAMessage[]
     */
    public function chatsControllerGetChatMessages($limit, $session, $chat_id, $sort_by = 'timestamp', $sort_order = null, $download_media = true, $merge = true, $offset = null, $filter_timestamp_lte = null, $filter_timestamp_gte = null, $filter_from_me = null, $filter_ack = null, string $contentType = self::contentTypes['chatsControllerGetChatMessages'][0])
    {
        list($response) = $this->chatsControllerGetChatMessagesWithHttpInfo($limit, $session, $chat_id, $sort_by, $sort_order, $download_media, $merge, $offset, $filter_timestamp_lte, $filter_timestamp_gte, $filter_from_me, $filter_ack, $contentType);
        return $response;
    }
     ...
     * @return array of \Vendor\Waha\Generated\Model\WAMessage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function chatsControllerGetChatMessagesWithHttpInfo($limit, $session, $chat_id, $sort_by = 'timestamp', $sort_order = null, $download_media = true, $merge = true, $offset = null, $filter_timestamp_lte = null, $filter_timestamp_gte = null, $filter_from_me = null, $filter_ack = null, string $contentType = self::contentTypes['chatsControllerGetChatMessages'][0])
    {
        $request = $this->chatsControllerGetChatMessagesRequest($limit, $session, $chat_id, $sort_by, $sort_order, $download_media, $merge, $offset, $filter_timestamp_lte, $filter_timestamp_gte, $filter_from_me, $filter_ack, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatsControllerGetChatMessagesAsync($limit, $session, $chat_id, $sort_by = 'timestamp', $sort_order = null, $download_media = true, $merge = true, $offset = null, $filter_timestamp_lte = null, $filter_timestamp_gte = null, $filter_from_me = null, $filter_ack = null, string $contentType = self::contentTypes['chatsControllerGetChatMessages'][0])
    {
        return $this->chatsControllerGetChatMessagesAsyncWithHttpInfo($limit, $session, $chat_id, $sort_by, $sort_order, $download_media, $merge, $offset, $filter_timestamp_lte, $filter_timestamp_gte, $filter_from_me, $filter_ack, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function chatsControllerGetChatMessagesRequest($limit, $session, $chat_id, $sort_by = 'timestamp', $sort_order = null, $download_media = true, $merge = true, $offset = null, $filter_timestamp_lte = null, $filter_timestamp_gte = null, $filter_from_me = null, $filter_ack = null, string $contentType = self::contentTypes['chatsControllerGetChatMessages'][0])
    {
     ...
     * @return void
     */
    public function chatsControllerGetChats($session, $sort_by = null, $sort_order = null, $merge = true, $limit = null, $offset = null, string $contentType = self::contentTypes['chatsControllerGetChats'][0])
    {
        $this->chatsControllerGetChatsWithHttpInfo($session, $sort_by, $sort_order, $merge, $limit, $offset, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function chatsControllerGetChatsWithHttpInfo($session, $sort_by = null, $sort_order = null, $merge = true, $limit = null, $offset = null, string $contentType = self::contentTypes['chatsControllerGetChats'][0])
    {
        $request = $this->chatsControllerGetChatsRequest($session, $sort_by, $sort_order, $merge, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatsControllerGetChatsAsync($session, $sort_by = null, $sort_order = null, $merge = true, $limit = null, $offset = null, string $contentType = self::contentTypes['chatsControllerGetChats'][0])
    {
        return $this->chatsControllerGetChatsAsyncWithHttpInfo($session, $sort_by, $sort_order, $merge, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatsControllerGetChatsAsyncWithHttpInfo($session, $sort_by = null, $sort_order = null, $merge = true, $limit = null, $offset = null, string $contentType = self::contentTypes['chatsControllerGetChats'][0])
    {
        $returnType = '';
        $request = $this->chatsControllerGetChatsRequest($session, $sort_by, $sort_order, $merge, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function chatsControllerGetChatsRequest($session, $sort_by = null, $sort_order = null, $merge = true, $limit = null, $offset = null, string $contentType = self::contentTypes['chatsControllerGetChats'][0])
    {
     ...
     */
    public function chatsControllerGetChatsOverview($session, $merge = true, $limit = 20, $offset = null, $ids = null, string $contentType = self::contentTypes['chatsControllerGetChatsOverview'][0])
    {
        list($response) = $this->chatsControllerGetChatsOverviewWithHttpInfo($session, $merge, $limit, $offset, $ids, $contentType);
        return $response;
    }
     ...
     */
    public function chatsControllerGetChatsOverviewWithHttpInfo($session, $merge = true, $limit = 20, $offset = null, $ids = null, string $contentType = self::contentTypes['chatsControllerGetChatsOverview'][0])
    {
        $request = $this->chatsControllerGetChatsOverviewRequest($session, $merge, $limit, $offset, $ids, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatsControllerGetChatsOverviewAsync($session, $merge = true, $limit = 20, $offset = null, $ids = null, string $contentType = self::contentTypes['chatsControllerGetChatsOverview'][0])
    {
        return $this->chatsControllerGetChatsOverviewAsyncWithHttpInfo($session, $merge, $limit, $offset, $ids, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function chatsControllerGetChatsOverviewAsyncWithHttpInfo($session, $merge = true, $limit = 20, $offset = null, $ids = null, string $contentType = self::contentTypes['chatsControllerGetChatsOverview'][0])
    {
        $returnType = '\Vendor\Waha\Generated\Model\ChatSummary[]';
        $request = $this->chatsControllerGetChatsOverviewRequest($session, $merge, $limit, $offset, $ids, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function chatsControllerGetChatsOverviewRequest($session, $merge = true, $limit = 20, $offset = null, $ids = null, string $contentType = self::contentTypes['chatsControllerGetChatsOverview'][0])
    {
