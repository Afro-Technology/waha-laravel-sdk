...
class StopResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('stopping', $data ?? [], true);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['stopping'] === null) {
            $invalidProperties[] = "'stopping' can't be null";
        }
     ...
     * Sets stopping
     *
     * @param bool $stopping Always 'true' if the server is stopping.
     *
     * @return self
     */
    ...
    {
        if (is_null($stopping)) {
            throw new \InvalidArgumentException('non-nullable stopping cannot be null');
        }
