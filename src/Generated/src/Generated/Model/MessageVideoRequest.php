 ...
 */
class MessageVideoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageVideoRequest';
    ...
    protected static $openAPITypes = [
        'chat_id' => 'string',
        'file' => '\VendorWahaGenerated\Model\MessageVideoRequestFile',
        'reply_to' => 'string',
        'as_note' => 'bool',
        'convert' => 'bool',
        'caption' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('as_note', $data ?? [], null);
        $this->setIfExists('convert', $data ?? [], null);
        $this->setIfExists('caption', $data ?? [], 'Just watch at this!');
    ...
    */
     ...
     * Gets file
     *
     * @return \VendorWahaGenerated\Model\MessageVideoRequestFile
     */
     ...
     * Sets file
     *
     * @param \VendorWahaGenerated\Model\MessageVideoRequestFile $file file
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getAsNote()
    {
        return $this->container['as_note'];
    }

    /**
     * Sets as_note
     *
     * @param bool|null $as_note Send as video note (aka instant or round video).
     *
     * @return self
     */
    public function setAsNote($as_note)
    {
        if (is_null($as_note)) {
            throw new \InvalidArgumentException('non-nullable as_note cannot be null');
        }
        $this->container['as_note'] = $as_note;
