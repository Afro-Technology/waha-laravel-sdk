 ...
 */
class WAMedia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WAMedia';
    ...
    protected static $openAPITypes = [
        ...
        'mimetype' => 'string',
        'filename' => 'string',
        's3' => '\VendorWahaGenerated\Model\S3MediaData',
        'error' => 'object'
    ];
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url The URL for the media in the message if any
     *
     * @return self
     */
     ...
     * Sets mimetype
     *
     * @param string|null $mimetype mimetype for the media in the message if any
     *
     * @return self
     */
     ...
     * Sets filename
     *
     * @param string|null $filename The original filename in mediaUrl in the message if any
     *
     * @return self
     */
     ...
     * Gets s3
     *
     * @return \VendorWahaGenerated\Model\S3MediaData|null
     */
     ...
     * Sets s3
     *
     * @param \VendorWahaGenerated\Model\S3MediaData|null $s3 S3 attributes for the media in the message if you are using S3 media storage
     *
     * @return self
     */
     ...
     * Sets error
     *
     * @param object|null $error Error message if there's an error downloading the media
     *
     * @return self
     */
