...
/**
 * SettingsSecurityChangeInfo Class Doc Comment
 *
 * @category Class
 * @package  VendorWahaGenerated
 * @author   OpenAPI Generator team
 ...
 */
class SettingsSecurityChangeInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SettingsSecurityChangeInfo';
    ...
    {
        $this->setIfExists('admins_only', $data ?? [], true);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['admins_only'] === null) {
            $invalidProperties[] = "'admins_only' can't be null";
        }
    ...
    {
        return $this->container['admins_only'];
    }

    /**
     * Sets admins_only
     *
     * @param bool $admins_only admins_only
     *
     * @return self
     */
    public function setAdminsOnly($admins_only)
    {
        if (is_null($admins_only)) {
            throw new \InvalidArgumentException('non-nullable admins_only cannot be null');
        }
        $this->container['admins_only'] = $admins_only;
