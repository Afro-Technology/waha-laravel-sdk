...
/**
 * MessagePollVoteRequest Class Doc Comment
 *
 * @category Class
 * @package  VendorWahaGenerated
 * @author   OpenAPI Generator team
 ...
 */
class MessagePollVoteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagePollVoteRequest';
    ...
    protected static array $openAPINullables = [
        'chat_id' => false,
        'poll_message_id' => false,
        'poll_server_id' => false,
        'votes' => false,
        'session' => false
    ];
    ...
    protected static $setters = [
        'chat_id' => 'setChatId',
        'poll_message_id' => 'setPollMessageId',
        'poll_server_id' => 'setPollServerId',
        'votes' => 'setVotes',
        'session' => 'setSession'
    ];
    ...
    protected static $getters = [
        'chat_id' => 'getChatId',
        'poll_message_id' => 'getPollMessageId',
        'poll_server_id' => 'getPollServerId',
        'votes' => 'getVotes',
        'session' => 'getSession'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('poll_message_id', $data ?? [], null);
        $this->setIfExists('poll_server_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['poll_message_id'] === null) {
            $invalidProperties[] = "'poll_message_id' can't be null";
        }
    ...
    /**
     * Gets poll_message_id
     *
     * @return string
     */
    public function getPollMessageId()
    {
        return $this->container['poll_message_id'];
    }

    /**
     * Sets poll_message_id
     *
     * @param string $poll_message_id The ID of the poll message. Format: {fromMe}_{chatID}_{messageId}[_{participant}] or just ID for GOWS
     *
     * @return self
     */
    public function setPollMessageId($poll_message_id)
    {
        if (is_null($poll_message_id)) {
            throw new \InvalidArgumentException('non-nullable poll_message_id cannot be null');
        }
        $this->container['poll_message_id'] = $poll_message_id;
     ...
     * @return float|null
     */
    public function getPollServerId()
    {
        return $this->container['poll_server_id'];
    }

    /**
     * Sets poll_server_id
     *
     * @param float|null $poll_server_id Only for Channels - server message id (if known); if omitted, API may look it up in the storage
     *
     * @return self
     */
    public function setPollServerId($poll_server_id)
    {
        if (is_null($poll_server_id)) {
            throw new \InvalidArgumentException('non-nullable poll_server_id cannot be null');
        }
        $this->container['poll_server_id'] = $poll_server_id;
