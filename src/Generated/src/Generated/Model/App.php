...
class App implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const APP_CHATWOOT = 'chatwoot';
    public const APP_CALLS = 'calls';
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Enable or disable this app without deleting it. If omitted, treated as enabled (true).
     *
     * @return self
     */
    ...
    public function setApp($app)
    {
        ...
        $allowedValues = $this->getAppAllowableValues();
        if (!in_array($app, $allowedValues, true)) {
