...
class ServerStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'uptime' => 'float',
        'worker' => '\VendorWahaGenerated\Model\WorkerInfo'
    ];
    ...
    */
     ...
     *
     * @param float $start_timestamp The timestamp when the server started (milliseconds).
     *
     * @return self
     */
     ...
     * Sets uptime
     *
     * @param float $uptime The uptime of the server in milliseconds.
     *
     * @return self
     */
     ...
     * Gets worker
     *
     * @return \VendorWahaGenerated\Model\WorkerInfo
     */
     ...
     * Sets worker
     *
     * @param \VendorWahaGenerated\Model\WorkerInfo $worker worker
     *
     * @return self
     */
