...
/**
 * ChatWootCommandsConfig Class Doc Comment
 *
 * @category Class
 * @package  VendorWahaGenerated
 * @author   OpenAPI Generator team
 ...
 */
class ChatWootCommandsConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatWootCommandsConfig';
    ...
    {
        $this->setIfExists('server', $data ?? [], true);
        $this->setIfExists('queue', $data ?? [], false);
    }
