 ...
 */
class LabelBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelBody';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('color_hex', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['color_hex'];
    }

    /**
     * Sets color_hex
     *
     * @param string|null $color_hex Color in hex
     *
     * @return self
     */
    public function setColorHex($color_hex)
    {
        if (is_null($color_hex)) {
            throw new \InvalidArgumentException('non-nullable color_hex cannot be null');
        }
        $this->container['color_hex'] = $color_hex;
     ...
     * Sets color
     *
     * @param float|null $color Color number, not hex
     *
     * @return self
     */
