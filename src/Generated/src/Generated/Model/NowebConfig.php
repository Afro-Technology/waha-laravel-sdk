 ...
 */
class NowebConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NowebConfig';
    ...
    protected static $openAPITypes = [
        'mark_online' => 'bool',
        'store' => '\VendorWahaGenerated\Model\NowebStoreConfig'
    ];
    ...
    {
        $this->setIfExists('mark_online', $data ?? [], true);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mark_online'] === null) {
            $invalidProperties[] = "'mark_online' can't be null";
        }
     ...
     * @return bool
     */
    public function getMarkOnline()
    {
        return $this->container['mark_online'];
    }

    /**
     * Sets mark_online
     *
     * @param bool $mark_online Mark the session as online when it connects to the server.
     *
     * @return self
     */
    public function setMarkOnline($mark_online)
    {
        if (is_null($mark_online)) {
            throw new \InvalidArgumentException('non-nullable mark_online cannot be null');
        }
        $this->container['mark_online'] = $mark_online;
     ...
     * Gets store
     *
     * @return \VendorWahaGenerated\Model\NowebStoreConfig|null
     */
     ...
     * Sets store
     *
     * @param \VendorWahaGenerated\Model\NowebStoreConfig|null $store store
     *
     * @return self
     */
