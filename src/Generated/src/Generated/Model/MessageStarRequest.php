...
/**
 * MessageStarRequest Class Doc Comment
 *
 * @category Class
 * @package  VendorWahaGenerated
 * @author   OpenAPI Generator team
 ...
 */
class MessageStarRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageStarRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['star'] === null) {
            $invalidProperties[] = "'star' can't be null";
        }
    ...
    {
        if (is_null($star)) {
            throw new \InvalidArgumentException('non-nullable star cannot be null');
        }
