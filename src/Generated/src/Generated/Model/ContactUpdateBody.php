...
/**
 * ContactUpdateBody Class Doc Comment
 *
 * @category Class
 * @package  VendorWahaGenerated
 * @author   OpenAPI Generator team
 ...
 */
class ContactUpdateBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactUpdateBody';
    ...
    {
        $this->setIfExists('first_name', $data ?? [], 'John');
        $this->setIfExists('last_name', $data ?? [], 'Doe');
    }
