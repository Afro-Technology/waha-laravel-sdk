...
/**
 * GroupParticipant Class Doc Comment
 *
 * @category Class
 * @package  VendorWahaGenerated
 * @author   OpenAPI Generator team
 ...
 */
class GroupParticipant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupParticipant';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Member ID in @c.us or @lid format
     *
     * @return self
     */
     ...
     * Sets pn
     *
     * @param string|null $pn Member ID in @c.us format
     *
     * @return self
     */
