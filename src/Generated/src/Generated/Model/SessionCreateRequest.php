...
/**
 * SessionCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  VendorWahaGenerated
 * @author   OpenAPI Generator team
 ...
 */
class SessionCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SessionCreateRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('start', $data ?? [], true);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Session name (id)
     *
     * @return self
     */
     ...
     * Sets apps
     *
     * @param \VendorWahaGenerated\Model\App[]|null $apps Apps to be synchronized for this session.
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param bool|null $start Start session after creation
     *
     * @return self
     */
