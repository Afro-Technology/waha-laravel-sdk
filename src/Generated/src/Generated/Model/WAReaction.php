 ...
 */
class WAReaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WAReaction';
    ...
    */
     ...
     * Sets text
     *
     * @param string $text Reaction to the message. Either the reaction (emoji) or empty string to remove the reaction
     *
     * @return self
     */
     ...
     * Sets message_id
     *
     * @param string $message_id Message ID for the message to react to
     *
     * @return self
     */
