 ...
 */
class MessagePoll implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagePoll';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('multiple_answers', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['multiple_answers'] === null) {
            $invalidProperties[] = "'multiple_answers' can't be null";
        }
     ...
     *
     * @param object $multiple_answers multiple_answers
     *
     * @return self
     */
    public function setMultipleAnswers($multiple_answers)
    {
        if (is_null($multiple_answers)) {
            throw new \InvalidArgumentException('non-nullable multiple_answers cannot be null');
        }
