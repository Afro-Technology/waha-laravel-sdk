...
class ChatsApi
{
     ...
     * @param  string $chat_id Chat ID (required)
     * @param  string $message_id Message ID in format &lt;code&gt;{fromMe}_{chat}_{message_id}[_{participant}]&lt;/code&gt; (required)
     * @param  \VendorWahaGenerated\Model\EditMessageRequest $edit_message_request edit_message_request (required)
     ...
     * @param  string $chat_id Chat ID (required)
     * @param  string $message_id Message ID in format &lt;code&gt;{fromMe}_{chat}_{message_id}[_{participant}]&lt;/code&gt; (required)
     * @param  \VendorWahaGenerated\Model\EditMessageRequest $edit_message_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chatsControllerEditMessage'] to see the possible values for this operation
     *
     * @throws \VendorWahaGenerated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  mixed $session Session name (required)
     * @param  float|null $limit limit (optional, default to 20)
     * @param  float|null $offset offset (optional)
     * @param  string[]|null $ids Filter by chat ids (optional)
     ...
     * @throws \VendorWahaGenerated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VendorWahaGenerated\Model\ChatSummary[]
     */
     ...
     *
     * @param  mixed $session Session name (required)
     * @param  float|null $limit (optional, default to 20)
     * @param  float|null $offset (optional)
     * @param  string[]|null $ids Filter by chat ids (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chatsControllerGetChatsOverview'] to see the possible values for this operation
     *
     * @throws \VendorWahaGenerated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VendorWahaGenerated\Model\ChatSummary[], HTTP status code, HTTP response headers (array of strings)
     */
    public function chatsControllerGetChatsOverviewWithHttpInfo($session, $limit = 20, $offset = null, $ids = null, string $contentType = self::contentTypes['chatsControllerGetChatsOverview'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\VendorWahaGenerated\Model\ChatSummary[]',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\VendorWahaGenerated\Model\ChatSummary[]';
        $request = $this->chatsControllerGetChatsOverviewRequest($session, $limit, $offset, $ids, $contentType);
     ...
     * @param  string $chat_id Chat ID (required)
     * @param  string $message_id message_id (required)
     * @param  \VendorWahaGenerated\Model\PinMessageRequest $pin_message_request pin_message_request (required)
     ...
     * @param  string $chat_id Chat ID (required)
     * @param  string $message_id (required)
     * @param  \VendorWahaGenerated\Model\PinMessageRequest $pin_message_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chatsControllerPinMessage'] to see the possible values for this operation
     *
     * @throws \VendorWahaGenerated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  mixed $session Session name (required)
     * @param  \VendorWahaGenerated\Model\OverviewBodyRequest $overview_body_request overview_body_request (required)
     ...
     *
     * @param  mixed $session Session name (required)
     * @param  \VendorWahaGenerated\Model\OverviewBodyRequest $overview_body_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['chatsControllerPostChatsOverview'] to see the possible values for this operation
     *
     * @throws \VendorWahaGenerated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  mixed $session Session name (required)
     * @param  string $chat_id Chat ID (required)
     * @param  float|null $messages How much messages to read (latest first) (optional)
     * @param  float|null $days How much days to read (latest first) (optional, default to 7)
     ...
     * @throws \VendorWahaGenerated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \VendorWahaGenerated\Model\ReadChatMessagesResponse
     */
     ...
     * @throws \VendorWahaGenerated\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \VendorWahaGenerated\Model\ReadChatMessagesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function chatsControllerReadChatMessagesWithHttpInfo($session, $chat_id, $messages = null, $days = 7, string $contentType = self::contentTypes['chatsControllerReadChatMessages'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\VendorWahaGenerated\Model\ReadChatMessagesResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\VendorWahaGenerated\Model\ReadChatMessagesResponse';
        $request = $this->chatsControllerReadChatMessagesRequest($session, $chat_id, $messages, $days, $contentType);
